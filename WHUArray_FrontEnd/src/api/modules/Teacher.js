...
export default {
  ...
  getCurCourseList (data, headers) {
    return axios({
      url: URL + "/course/findCurCourse/" + data.teacherId,
      method: "get",
      headers: headers,
    });
  },
  ...
  getPreCourseList (data, headers) {
    return axios({
      url: URL + "/course/findPreCourse/" + data.teacherId,
      method: "get",
      headers: headers,
    });
  },
  ...
  getCourseWork (data, headers) {
    return axios({
      url: URL + "/course/getHomeworkByCourseId/" + data.courseId,
      method: "get",
      headers: headers,
    });
  },
  ...
  getCourseStudentList (data, headers) {
    return axios({
      url: URL + "/course/" + data.courseId + "/allStudent",
      method: "get",
      headers: headers,
    });
  },
  ...
  editWork (data, headers) {
    return axios({
      url: URL + "/homework/updateHomework",
      method: "put",
      data: data,
      headers: headers,
    });
  ...
  editProblem (data, headers) {
    return axios({
      url: URL + "/question/updateQuestion",
      method: "put",
      data: data,
      headers: headers,
    });
  ...
  getCurrentTeacher (headers) {
    return axios({
      url: URL + "/teacher/currentUser",
      method: "get",
      headers: headers,
    });
  },
